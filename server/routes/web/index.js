...
module.exports = app => {
  ...
  router.get("/news/init", async (req, res) => {
    ...
    const newsTitles = [
      "王者峡谷云赛舟，今年端午特别“浪”",
      "“Spark More”王者荣耀打造玩家新触点，让游戏焕活更多传统文化的可能",
      "腾讯游戏年度发布会，一张图带你看天美最新动态！",
      "集合，准备上船！——谁是峡谷最佳龙舟手？",
      "英雄调整情报丨貂蝉加强，赵云优化",
      "6月30日青少年及家长模式开启公告",
      "6月30日全服不停机更新公告",
  ...
  router.get("/heroes/list", async (req, res) => {
    ...
    const cats = await Category.aggregate([
      //聚合查询
      { $match: { parent: parent._id } }, //条件查询，管道查询
      {
        $lookup: {
          //关联查询
          from: "heroes",
  ...
  router.get("/articles/:id", async (req, res) => {
    const data = await Article.findById(req.params.id).lean(); //变成json对象
